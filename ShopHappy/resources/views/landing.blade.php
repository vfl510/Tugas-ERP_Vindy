...
<head>
  ...
  <title>ShopHappy - Landing Page</title>
    ...
    <div class="container">
      ...
      <div class="row align-items-center text-center text-md-left">
        <div class="col-md-6 col-lg-5 mb-5 mb-md-0">
          ...
          <p>
          	ShopHappy, Aplikasi yang bisa anda gunakan untuk melihat data penjualan, data transaksi, riset penjualan, dsb. 
          </p>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="service-card text-center">
            ...
            <div class="service-card-body">
              <h3>Vindy F.L.</h3>
              <p>
                Buat ini untuk tugas... <i class="fas fa-leaf"></i>
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="service-card-body">
              ...
              <div class="media contact-info">
                ...
                <div class="media-body">
                  <h3>dag.alley555@gmail.com</h3>
                  <p>Hubungi saya, kalau bisa ...</p>
                </div>
              </div>
            </div>
          </div>
